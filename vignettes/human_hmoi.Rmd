...
m_{1} = h/r_{1}
$$
We can use this to calcualte the net infectious probability, and then $\kappa = x \cdot H$, allowing the equilibrium solutions of this model to feed into the other components.

# Example

Here we run a simple example with 3 population strata at equilibrium. We use `xDE::make_parameters_X_hMoI` to
