...
## 2. The **exDE** R package

Code orgnization, whats auto-generated, whats part of pkgdown, etc

## 3. How to make large changes

## 4. How to test locally

How to use testthat and devtools

## 5. How to make or review a pull request
...
## 6. How to deal with continuous integration

## 7. How to get ready for a version update

update DESCRIPTION version, how to submit to CRAN, check that pkgdown website worked, etc.

## 8. How to report bugs or raise issues?
