...
After making changes to **exDE** but before submitting a PR, you should take some time to do local tests to make sure that the package still works.

Remember, the tests run in `tests/testthat` can only check the code you have specifically put there to be tested! Any large changes 
