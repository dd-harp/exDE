...
```{r}
mosy1 = xde_setup_mosy("mosy1", MYZname = "basicM", Lname = "trace", nPatches = 3, membership = c(1,2,3,3), MYZopts = MYZo, calK = calK, Lopts = Lo, kappa = c(0.1, 0.075, 0.025))
```

```{r}
xde_solve(mosy1,50,1)$deout -> out2
sum(out2-out1)
```
