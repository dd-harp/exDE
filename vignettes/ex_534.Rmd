...
params = make_parameters_L_basic(pars = params, psi = psi, phi = phi, theta = theta, L0 = L0)
```
...
params = make_parameters_MYZ_GeRM_ode(pars = params, g = g, sigma = sigma, calK = calK, tau = tau, f = f, q = q, nu = nu, eggsPerBatch = eggsPerBatch, M0 = M0, G0 = G0, Y0 = Y0, Z0 = Z0)
```
...
params = make_parameters_X_SIS(pars = params, b = b, c = c, r = r, Psi = Psi, X0 = X0)
