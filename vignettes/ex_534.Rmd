...
params = make_parameters_MYZ_RM(pars = params, g = g, sigma = sigma, calK = calK, tau = tau, f = f, q = q, nu = nu, eggsPerBatch = eggsPerBatch, solve_as = "ode") 
params = make_inits_MYZ_RM(params, M0 = M0, Y0 = Y0, Z0 = Z0, Upsilon0=Upsilon)
```
