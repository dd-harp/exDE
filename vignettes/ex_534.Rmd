...
params = make_Xinits_SIS(params, I0=I0)
```
...
```{r, out.width = "100%"}
colnames(out)[params$ix$L$L_ix+1] <- paste0('L_', 1:params$nHabitats)
...
colnames(out)[params$ix$MYZ$Y_ix+1] <- paste0('Y_', 1:params$nPatches)
colnames(out)[params$ix$MYZ$Z_ix+1] <- paste0('Z_', 1:params$nPatches)
colnames(out)[params$ix$X$X_ix+1] <- paste0('X_', 1:params$nStrata)
