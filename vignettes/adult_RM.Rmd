...
params$eir_out = FALSE 
params$fqZ_out = FALSE 
params$NI_out = FALSE 
params$kappa_out = FALSE 
```
...
xde_setup("MYZeg",
    ...
    MYZopts = MYZo, Xopts = Xo, Lopts = Lo, eir_out=FALSE, fqZ_out=FALSE, NI_out=FALSE, kappa_out=FALSE) -> MYZeg
```
