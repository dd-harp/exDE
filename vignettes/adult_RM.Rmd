...
Now we set up the parameter list with the correct class using `xDE::make_parameters_MYZ_RM_ode`. Then we can set up the initial conditions vector and use `deSolve::ode` to solve the model.
