...
Now we set up the parameter list with the correct class using `exDE::make_parameters_MYZ_RM_ode`. Then we can set up the initial conditions vector and use `deSolve::ode` to solve the model.
...
out <- deSolve::ode(y = y0, times = 0:50, func = function(t, y, pars, Lambda, kappa) {
