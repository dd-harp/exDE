...
pars = make_parameters_MYZ_GeRM_dde(pars = pars, g = g, sigma = sigma, calK = calK, f = f, q = q, nu = nu, eggsPerBatch = eggsPerBatch, tau = tau, M0 = M, G0 = G, Y0 = Y, Z0 = Z)
pars = make_parameters_L_basic(pars = pars, psi = psi, phi = phi, theta = theta, L0 = L)
pars = make_parameters_X_SIS(pars = pars, b = b, c = c, r = r, Psi = Psi, wf = wf, X0 = X)
