...
colnames(out)[itn_mod$ix$L$L_ix+1] <- paste0('L_', 1:itn_mod$nHabitats)
colnames(out)[itn_mod$ix$MYZ$M_ix+1] <- paste0('M_', 1:itn_mod$nPatches)
colnames(out)[itn_mod$ix$MYZ$P_ix+1] <- paste0('P_', 1:itn_mod$nPatches)
colnames(out)[itn_mod$ix$MYZ$Y_ix+1] <- paste0('Y_', 1:itn_mod$nPatches)
colnames(out)[itn_mod$ix$MYZ$Z_ix+1] <- paste0('Z_', 1:itn_mod$nPatches)
colnames(out)[itn_mod$ix$X$X_ix+1] <- paste0('X_', 1:itn_mod$nStrata)

out <- out[, -c(itn_mod$ix$MYZ$sigma_ix+1)]
out <- out[, -c(itn_mod$ix$MYZ$g_ix+1)]
out <- out[, -c(itn_mod$ix$MYZ$fqkappa_ix+1)]
out <- out[, -c(itn_mod$ix$MYZ$Upsilon_ix+1)]
