...
#source ("../R/human-interface.R")
#source ("../R/human-SIS.R")
#source ("../R/diffeqn.R") 
#source ("../R/bloodfeeding.R") 
#source ("../R/demography-interface.R")
#source ("../R/demography-null.R")
#source ("../R/exogenous-interface.R")
#source ("../R/exogenous-null.R")
#source ("../R/vc-interface.R")
#source ("../R/vc-lemenach.R")
library(MASS)
library(expm)
library(deSolve)
library(data.table)
...
pars = make_parameters_vc_lemenach(pars, phi = ITN_cov)
pars = make_parameters_MYZ_GeRM(pars = pars, g = g, 
                                sigma = sigma, calK = calK, 
                                f = f, q = q, nu = nu, 
                                eggsPerBatch = eggsPerBatch, 
                                tau = tau)
pars = make_inits_MYZ_GeRM(pars = pars, M0 = M, G0 = G, 
                           Y0 = Y, Z0 = Z,Upsilon0=Upsilon)
pars = attach_inits_MYZ(pars)
...
pars = attach_inits_X(pars)
pars = make_parameters_demography_null(pars = pars, H = H,
                                       membershipH = membershipH,
                                       searchWtsH = searchWtsH, 
                                       TimeSpent = Psi)
