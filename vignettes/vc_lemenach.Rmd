...
pars = make_parameters_demography_static(pars = pars, H = H,
                                       membershipH = membershipH,
                                       searchWtsH = searchWtsH, 
                                       TimeSpent = Psi)
W = as.vector(pars$Hpar$TimeSpent %*% (pars$Hpar$searchWtsH * H))
pars$beta = diag(pars$Hpar$searchWtsH, pars$nStrata) %*% t(pars$Hpar$TimeSpent) %*% diag(1/W, pars$nPatches)
