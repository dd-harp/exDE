...
```{r}
itn_mod = make_parameters_vc_control(itn_mod)
itn_mod = make_parameters_itn_lemenach(itn_mod, phi = ITN_cov)
```

```{r}
xde_solve(itn_mod, 5*365) -> out
```
