...
params = make_inits_X_SIP(pars = params, I, as.vector(P))
...
```{r, out.width = "100%"}
colnames(out)[params$ix$X$X_ix+1] <- paste0('I_', 1:params$nStrata)
colnames(out)[params$ix$X$P_ix+1] <- paste0('P_', 1:params$nStrata)
